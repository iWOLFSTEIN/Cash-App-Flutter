...
class SpinningWheelScreen extends StatefulWidget {
  SpinningWheelScreen({Key key}) : super(key: key);
...
class _SpinningWheelScreenState extends State<SpinningWheelScreen>
  ...
  void initState() {
    ...
    animation = CurvedAnimation(parent: rotationController, curve: Curves.ease);
  }
                        ...
                        if (snapshot.data.coins >= 10) {
                          ...
                          Future.delayed(Duration(milliseconds: 1500), () {
                            ...
                            var itemType = rewardsLogic.getReward(
                              reward,
                              currentCoins: snapshot.data.coins - 10,
                          ...
                          CoolAlert.show(
                            ...
                            text:
                                "You require atleast 10 coins to spin the wheel.",
                          );
                        }
                      } catch (e) {
                        CoolAlert.show(
